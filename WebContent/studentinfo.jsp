...
<header>
  ...
  <ul><h3><b><%=userID %>님</b><br> 반갑습니다!</h3>
  		...
  		<ul><h3><b>학적관리</b><br></h3>
  		<li><a href="absenceApply.jsp">휴학 신청 </a></li>
  	...
  	<%} %>
        ...
        <!-- 		스크립트로 넘기기위해서 form에도 name값을 준다  -->
                ...
                <tr rowspan="2">
                    ...
                    <td colspan="4" style="text-align:center;"><h2>학생 정보</h2><br>
                  </td>
                ...
                <tr>
                    ...
                    <input type="button" value="학생정보 수정하기" onclick="location.href='setStudentInfo.jsp'">
