			...
			<div class="p-5 text-center bg-light" style="margin-top: 20px;">
				<form method="post" action="searchIdAction.jsp">
					...
					<div class="form-group">
						<input type="text" class="form-control mb-3" placeholder="이름" name="userName" maxlength="20" required>
					</div>
					
					<input type="submit" class="btn btn-primary form-control mb-3" value="아이디 찾기">
